...
La nivel de login: fisierul contine utilizatorii inregistrati la server. Daca utilizatorul este conectat, numarul din fisier este schimbat in 1 ca sa nu intram pe acelasi cont de pe un alt terminal. 

Cum sa executati?

Aplicatia functioneaza la nivel local. Deschideti 2 terminale separate si compilati cele 2 script-uri.

gcc client.c -o client
gcc server.c -o server


Executati cele 2 aplicatii in ordinea asta: server si dupa client
./server
./client
